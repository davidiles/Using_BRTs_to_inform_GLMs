...
The Bayesian model resulted in lower RMSE for `r round(mean(results$RMSE_inla < results$RMSE_brt),2)`% of simulations.  

Additionally, predictions from the Bayesian model had a higher correlation with the true response surface in `r round(mean(results$cor_inla > results$cor_brt),2)`% of simulations.
