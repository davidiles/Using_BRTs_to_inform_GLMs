...
We used simulations to examine whether a two-stage approach to fitting models (BRTs to identify covariates, followed by a Bayesian model to properly account for uncertainty) improves species distribution estimates, compared to just fitting a BRT.
...
```{r simulation_example, cache = TRUE}
