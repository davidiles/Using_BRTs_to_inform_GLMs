...
```{r simulate_landscapes, results = 'hide', cache=TRUE, fig.width=10, fig.height=10, include = FALSE}
...
```{r species_distribution, results = 'hide', fig.width=6, fig.height=6, include = FALSE}
# Covariate effects
coefs <- rep(0,n_var)
...
```{r conduct_repeated_simulations}
results <- data.frame()
